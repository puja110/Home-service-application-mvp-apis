...
package com.doransoft.np.homeservice.application.network.ProductCategoriesDAO;
...
public class ProductCategories implements Serializable, Parcelable
{
    ...
    protected ProductCategories(Parcel in) {
        ...
        in.readList(this.message, (com.doransoft.np.homeservice.application.network.ProductCategoriesDAO.Message.class.getClassLoader()));
    }
